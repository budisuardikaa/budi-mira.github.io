...
<?php
  $pin=$_POST['1'].$_POST['2'].$_POST['3'].$_POST['4'].$_POST['5'].$_POST['6'];
  if($pin=='121117'){
    $s=1;
  }else{
    $s=0;
  ...
  if($s==0){
    echo"<script>
      Swal.fire({
        text: 'KOK PIN SALAH SIH MEOWW.',
        imageUrl: 'dist/img/salah.png',
        imageWidth: 200,
        imageHeight: 200,
    ...
    echo"<script>
      Swal.fire({
        text: 'PIN BENAR MEOWW.',
        imageUrl: 'dist/img/1.png',
        imageWidth: 200,
        imageHeight: 200,
        imageAlt: 'BENAR MEOWW',
        focusConfirm: true,
        confirmButtonText:
          'OK'
        }).then ((result) => {
          if (result.isConfirmed) {
            location.href = 'games1.php';
        }
      })
    </script>";
  }
